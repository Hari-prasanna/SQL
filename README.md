...
### 1. [Overstock Inventory Reconciliation](./Resolving Inventory Discrepancies)
...
### 2. [Manual Sorting Deduplication Algorithm](./LUU-receive-manual-booking)
...
### 3. [Goodcabs Transportation Analytics](./Transportation Insights for Chief of Operations)
